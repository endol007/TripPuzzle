...
public class JspGpsRegister extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jspgpsregister);
        //execute의 매개값은
        ...
        regsexman = (CheckBox) findViewById(R.id.regsexman);
        regsexwoman = (CheckBox) findViewById(R.id.regsexwoman);
        ...
        regtolbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent tologinintent = new Intent(JspGpsRegister.this, Login.class);
                JspGpsRegister.this.startActivity(tologinintent);
                finish();
        ...
        registerbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    result = task.execute(userID, userPassword, userName, String.valueOf(userAge), userSex, userPhone, userMail, gpsLati, gpsLong).get();
                    Log.i("리턴 값", result);
    ...
    class CustomTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                String str;
                URL url = new URL("http://182.210.78.154:8080/RegisterGps.jsp");//보낼 jsp 주소를 ""안에 작성합니다.
                HttpURLConnection conn = (HttpURLConnection) url.openConnection();
                conn.setRequestProperty("Content-Type", "application/x-www-form-urlencoded");
                conn.setRequestMethod("POST");//데이터를 POST 방식으로 전송합니다.
                OutputStreamWriter osw = new OutputStreamWriter(conn.getOutputStream());
                sendMsg = "&userID="+strings[0]+"&userPassword="+strings[1]+"&userName="+strings[2]+"&userAge="+strings[3]+"&userSex="+strings[4]+"&userPhone="+strings[5]+"&userMail="+strings[6]+"&gpsLati="+strings[7]+"&gpsLong="+strings[8];
