...
public class KakaoAdp extends Application {

    private static volatile KakaoAdp instance = null;
        ...
        public IApplicationConfig getApplicationConfig() {
            return new IApplicationConfig() {
                ...
                public Context getApplicationContext() {
                    return KakaoAdp.getGlobalApplicationContext();
                }
            };
        }
    }

    public static KakaoAdp getGlobalApplicationContext() {
        if(instance == null) {
